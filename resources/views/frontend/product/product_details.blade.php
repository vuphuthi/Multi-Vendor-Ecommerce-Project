    ...
    <div class="row">
        <div class="col-xl-10 col-lg-12 m-auto">
            <div class="product-detail accordion-detail">
                <div class="row mb-50 mt-30">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            ...
                            @endif
                            <h2 class="title-detail" id="dname">{{$product->product_name}}</h2>
                        ...
                        <div class="tab-content shop_info_tab entry-main-content">
                            ...
                            <div class="tab-pane fade" id="Vendor-info">
                                <div class="vendor-logo d-flex mb-30">
                                    ...
                                    @if ($product->vendor_id == NULL)
                                    <a href="vendor-details-2.html">Người sở hữu</a>
                                    @else
                                    <h6>
                                ...
                                <ul class="contact-infor mb-50">
                                    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-location.svg') }}" alt="" /><strong>Địa chỉ: </strong> <span>Chủ sở hữu</span></li>
                                    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}" alt="" /><strong>Liên hệ: </strong><span>Chủ sở hữu</span></li>
                                </ul>
                                @else
                                <ul class="contact-infor mb-50">
                                    <li><img src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Địa chỉ: </strong> <span>{{$product['vendor']['address']}}</span></li>
                                    <li><img src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Liên hệ: </strong><span>{{$product['vendor']['phone']}}</span></li>
                                </ul>
                                @endif
                                @if($product->vendor_id == NULL)
                                <p>Thông tin của chủ sở hữu</p>
                                @else
                ...
                <div class="row mt-60">
                    <div class="col-12">
                        <h2 class="section-title style-1 mb-30">Những sảm phẩm tương tự</h2>
                    </div>
