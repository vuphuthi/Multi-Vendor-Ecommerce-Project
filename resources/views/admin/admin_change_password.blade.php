...
<div class="page-content"> 
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Quản trị viên đổi mật khẩu</div>
        <div class="ps-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    @error('old_password') is-invalid @enderror placeholder="Mật khẩu cũ" 
                                    id="current_password" />
                                    @error('old_password')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    @error('new_password') is-invalid @enderror placeholder="Mật khẩu mới" 
                                    id="new_password" />
                                    @error('new_password')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
