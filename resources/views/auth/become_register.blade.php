        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> Trang <span></span> Đăng ký Nhà cung cấp
                </div>
            </div>
        </div>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            <h1 class="mb-5">Trở thành nhà cung cấp</h1>
                                            <p class="mb-30">Bạn đã có tài khoản? <a href="{{route('vendor.login')}}">Đăng nhập</a></p>
                                        </div>
                                        <form method="POST" action="{{ route('becom.register') }}">
                                            @csrf
                                            <div class="form-group">
                                                <input type="text" id="name" required="" name="name" placeholder="Tên cửa hàng" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" id="username" required="" name="username" placeholder="Tên tài khoản" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                <input type="text" id="phone" required="" name="phone" placeholder="Số điện thoại" />
                                            </div>
                                            <div class="form-group">
                                                <select name="vendor_join" class="form-select mb-3" aria-label="Default select example">
                                                   <option selected=""><p>Vui lòng chọn ngày gia nhập</p></option>
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="address" required="" name="address" placeholder="Địa chỉ" />
                                            </div>
