                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{route('active.vendor.approve')}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" id="" value="{{$inActiveVendorDetails->id}}"> 
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" disabled name="name" class="form-control" value="{{$inActiveVendorDetails->name}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="email" disabled name="email" class="form-control" value="{{$inActiveVendorDetails->email}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" disabled name="phone" class="form-control" value="{{$inActiveVendorDetails->phone}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" disabled name="address" class="form-control" value="{{$inActiveVendorDetails->address}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <select name="vendor_join" disabled class="form-select mb-3" aria-label="Default select example">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <textarea name="vendor_short_info" disabled class="form-control" id="inputAddress2" placeholder="Thông tin " rows="3">{{$inActiveVendorDetails->vendor_short_info}}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="file" disabled name="photo" class="form-control" id="image"/>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="submit" class="btn btn-danger px-4" value="Active nhà cung cấp" />
                                </div>
                            </div>
                            </form>
                        </div>
