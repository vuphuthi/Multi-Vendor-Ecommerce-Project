                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="myForm" method="post" action="{{ route('update.slider') }}" enctype="multipart/form-data" >
                                @csrf
                                <input type="hidden" name="id" id="" value="{{$sliders->id}}">
                                <input type="hidden" name="old_image" id="" value="{{$sliders->slider_image}}">
                            <div class="row mb-3">
                                <div class="foe col-sm-3">
                                    <h6 class="mb-0">Tiêu đề</h6>
                                </div>
                                <div class="form-group col-sm-9 text-secondary">
                                    <input type="text" placeholder="Sửa danh mục" value="{{$sliders->slider_title}}" name="slider_title" class="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9 text-secondary">
                                    <input type="text" placeholder="Sửa danh mục" value="{{$sliders->short_title}}" name="short_title" class="form-control" />
                                </div>
                            </div>
