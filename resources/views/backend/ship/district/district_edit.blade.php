...
<div class="page-content"> 
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Chỉnh sửa Quận huyện</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Chỉnh sửa quận huyện</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('update.district') }}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Tên Quận huyện</h6>
                                    </div>
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="district_name" value="{{ $district->district_name }}" placeholder="Nhập khu vực của bạn" class="form-control" />
                                    </div>
                                </div>
